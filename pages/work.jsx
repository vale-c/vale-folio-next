...
const Work = ({ isWorkPage = true }) => {
  return (
    <>
      <section className="flex flex-col pt-8 sm:py-12">
        {isWorkPage && (
        ...
        <Container>
          <div className="relative mb-8">
            ...
            <span className="font-lato text-gray-700 dark:text-gray-50">
              Check out my{' '}
              <a
            ...
            <ProjectsWrapper>
              ...
              >
                <InnerCardText>
                  An educational Web App to help other developers learn Vim
                  which I made as a project for the Edu Tech class I attended as
                  part of my MSc in CS at Georgia Tech.
                </InnerCardText>
              </ProjectCard>
              <ProjectCard
              ...
              >
                <InnerCardText>
                  A replica of the Space X website built with Vite.js,
              ...
              >
                <InnerCardText>
                  City Stats is a React Web App that connects to the Teleport
                  API to help you find out and compare some of the most useful
